...
func Initialize() error {
	...
	_, err = readDB.Exec(stmtInitialization, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime, uuid.NewV4(), currentTime, currentTime)
